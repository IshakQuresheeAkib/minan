  ...
  return (
    <section className="mx-auto w-full max-w-3xl px-4 py-8 sm:px-6 sm:py-12">
      ...
      <div className="mt-6" aria-live="polite">
        ...
        {order ? <div><OrderTrackingDetails order={order} /><p className="mt-5 rounded-xl border border-primary/35 bg-primary/10 p-4 text-sm leading-6">To view Orders already attached to your MINAN account, <Link className="font-semibold underline" href={`${publicRoutes.customerLogin}?next=${encodeURIComponent("/account/orders")}`}>sign in to My Orders.</Link></p></div> : null}
