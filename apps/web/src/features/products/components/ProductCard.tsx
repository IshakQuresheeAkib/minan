...
export const productCardShellClassName =
  "group/card flex h-full flex-col overflow-hidden rounded-2xl border border-secondary/70 bg-background shadow-[0_8px_24px_rgba(151,72,34,0.05)] transition-[border-color,box-shadow] duration-200 hover:border-primary/70 hover:shadow-[0_14px_34px_rgba(151,72,34,0.11)]";
