...
type RichTextEditorProps = Omit<ComponentPropsWithoutRef<"div">, "onChange"> & {
  disabled?: boolean;
...
function ToolbarButton({
  ...
  return (
    <Button
      ...
      className={cn(
        "size-8 shrink-0 rounded-md border-transparent bg-transparent p-0 text-foreground/65 shadow-none transition-colors duration-300 hover:bg-primary/15 hover:text-foreground hover:shadow-none focus-visible:ring-2",
  ...
  function RichTextEditor(
    ...
    return (
      <div
        ...
        tabIndex={-1}
        className={cn(
          "overflow-hidden rounded-lg border border-secondary/80 bg-background transition-[border-color,box-shadow] duration-300 focus-within:border-primary/70 focus-within:ring-2 focus-within:ring-primary/25",
          isInvalid &&
